...
func Init() error {
	...
	err = db.AutoMigrate(&proto.MyVPNUserLoginInfo{})
	if err != nil {
		log.Println("my vpn user login info db table:", err)
		return err
	} else {
		log.Println("my vpn user login info db table migrated successfully")
	}
