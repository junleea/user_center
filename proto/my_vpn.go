...
const (
	...
	PolicyUserToSelf int = 2094967212
	PolicyUserAll int = 2094967223
)
...
type ServerConfig struct {
	...
	DPMaxSession    int         `json:"dp_max_session" form:"dp_max_session"`   // 最大会话数
	Tunnel          string      `json:"tunnel" form:"tunnel"`
...
type GetClientConfigOnlineResponse struct {
	...
	GatewayIPv6      string `json:"gateway_ipv6" form:"gateway_ipv6"`
